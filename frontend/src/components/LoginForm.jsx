                ...
                <div className='w-full max-w-md animate-fade-in'>
                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder='himu@gmail.com' className='w-full px-4 py-2 border rounded-lg pr-11 focus:outline-none focus:ring-2 focus:ring-indigo-500' />
                        </div>
                        ...
                        <div>
                            ...
                            <div className='relative'>
                                <input
                                    ...
                                    required
                                    className='w-full px-4 py-2 border rounded-lg pr-11 focus:outline-none focus:ring-2 focus:ring-indigo-500'
                                    placeholder='*********'
                                />
